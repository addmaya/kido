...
<section class="o-section">
	<div class="u-box">
		<section class="c-setup">
			<header>
				<h2>Your <span>'Retirement'</span> goal setup</h2>
			</header>
				...
				<div class="swiper-wrapper">					
					...
					<div class="swiper-slide">
						<section class="c-setup-summary">
							...
							<ul>
								<li><span>First month of retirement</span></li>
								<li><span>USh. 29,948,916</span></li>
							</ul>
							<ul>
								<li><span>First year of retirement</span></li>
								<li><span>USh. 129,948,916</span></li>
							</ul>
							<ul>
