...
<section class="o-section">
	<div class="u-box">
		<section class="c-setup">
			<header>
				<h2>Let's setup your <span>'Generate Income'</span> goal</h2>
			</header>
				...
				<div class="swiper-wrapper">					
					<div class="swiper-slide">
						<section>
							<form>
								...
								<p class="u-footnote">Enter income you want to draw from your investments to finance your lifestyle e.g if you have just retired and have got your NSSF and you want it to last you through retirement, enter the monthly expenditure you will need to finance during retirement.</p>
							</form>
						</section>
					...
					<div class="swiper-slide">
						<section>
							<form>
								<div class="c-setup-question">
									<p>I want to start drawing this income in</p>
									<div class="o-input">
										<input type="text"/>
										<span></span>
									</div>
