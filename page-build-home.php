...
<section class="o-section">
	<div class="u-box">
		<section class="c-setup">
			<header>
				<h2>Let's setup your <span>'Building Home'</span> goal</h2>
			</header>
					...
					<div class="swiper-slide">
						<section>
							<form>
								...
								<p class="u-footnote">Please enter an achievable target.</p>
							</form>
						</section>
					...
					<div class="swiper-slide">
						<section>
							<form>
								...
								<p class="u-footnote">Enter numbers of years you are likely to take to save up the funds required to build or purchase.</p>
							</form>
						</section>
						<div class="c-setup-footer">
