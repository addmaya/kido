...
<section class="o-section">
	<div class="u-box">
		<section class="c-setup">
			<header>
				<h2>Let's setup your <span>'Emergencies'</span> goal</h2>
			</header>
						...
						<section>
							<form>
								<div class="c-setup-question">
									<p>I would to secure USh.</p>
									<div class="o-input">
										<input type="text" autofocus="autofocus" class="js-thousands"/>
										<span></span>
									</div>
									<p>for my emergency fund.</p>
								</div>					
								<p class="u-footnote">Please enter preferred level of funds.</p>
							</form>
						</section>
					...
					<div class="swiper-slide">
						<section>
							<form>
								...
								<p class="u-footnote">Enter numbers of years you are likely to take to save up the funds required to build up your emergency funds.</p>
							</form>
						</section>
						<div class="c-setup-footer">
