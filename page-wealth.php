...
<section class="o-section">
	<div class="u-box">
		<section class="c-setup">
			<header>
				<h2>Let's setup your <span>'Building Wealth'</span> goal</h2>
			</header>
					...
					<div class="swiper-slide">
						<section>
							<form>
								...
								<p class="u-footnote">Please enter an achievable target and the numbers of years you are likely to take to build your wealth.</p>
							</form>
						</section>
